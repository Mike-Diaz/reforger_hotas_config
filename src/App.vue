...
const ACTIONS: Omit<Action, 'bindings'>[] = [
  ...
  { name: 'CarThrust', filterPreset: 'axis', hint: 'Accelerate the car / vehicle', hardware: 'throttle', importance: 'optional' },
  { name: 'CarBrake', filterPreset: 'axis', hint: 'Brake pedal or axis input', hardware: 'pedals', importance: 'optional' },
  { name: 'CarSteering', filterPreset: 'left', hint: 'Steer left and right', hardware: 'stick', importance: 'optional' },
  { name: 'CarTurbo', filterPreset: 'hold', hint: 'Hold to engage turbo / boost', hardware: 'button', importance: 'optional' },
  { name: 'CarTurboToggle', filterPreset: 'click', hint: 'Toggle turbo / boost mode', hardware: 'button', importance: 'optional' },
  { name: 'CarHandBrake', filterPreset: 'pressed', hint: 'Momentary hand brake', hardware: 'button', importance: 'optional' },
  { name: 'CarHandBrakePersistent', filterPreset: 'pressed', hint: 'Persistent hand brake (toggle)', hardware: 'button', importance: 'optional' },
  { name: 'VehicleEngineStart', filterPreset: 'hold', hint: 'Start vehicle engine', hardware: 'button', importance: 'optional' },
  { name: 'VehicleEngineStop', filterPreset: 'click', hint: 'Stop vehicle engine', hardware: 'button', importance: 'optional' },
  { name: 'CarShift', filterPreset: 'up', hint: 'Shift up/down', hardware: 'hat', importance: 'optional' },
