...
const ACTIONS: Omit<Action, 'bindings'>[] = [
  ...
  { name: 'CarThrust', filterPreset: 'axis', hint: 'Accelerate the car / vehicle', hardware: 'throttle', importance: 'critical' },
  { name: 'CarBrake', filterPreset: 'axis', hint: 'Brake pedal or axis input', hardware: 'pedals', importance: 'critical' },
  { name: 'CarSteering', filterPreset: 'left', hint: 'Steer left and right', hardware: 'stick', importance: 'critical' },
